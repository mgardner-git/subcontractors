...
public class ShiftController {
	...
	public @ResponseBody Shift create(@RequestBody Shift shift) {
		logger.info("Creating Shift: " + shift.getBegin() + ":" + shift.getEnd());
		shift.setSubcontractor(Util.getLoggedInUser());
	...
	public @ResponseBody Shift update(@RequestBody Shift shift) {
		logger.info("Updating project: " + shift.getId());
		Shift result = service.update(shift);
		return result;
	}
